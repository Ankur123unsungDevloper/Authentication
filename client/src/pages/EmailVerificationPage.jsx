    ...
    <div className="max-w-md w-full bg-gray-800 bg-opacity-50 backdrop-filter backdrop-blur-xl rounded-2xl shadow-xl overflow-hidden">
      ...
      >
        ...
        <p className="text-center text-gray-300 mb-6">
          Enter the 6-digit code sent to code send sent to your email address.
        </p>
          ...
          <div className="flex justify-between">
            { code.map((digit, index) => (
              <input
                ...
                className="w-12 h-12 text-center font-bold bg-gray-700
                text-white border-2 border-gray-600 rounded-lg focus:outline-none focus:border-green-500"
              />
            )) }
          </div>
